   ...
   <div>
      <div class="container">
         <div class="banner" :class="{ 'banner-clicked': isBannerClicked }">
            <a :href="videoSrc" class="side one" @click.prevent="show">
               <img class="img" src="/assets/images/eagle.png" />
            </a>
         </div>
      </div>
      ...
      <teleport to="body">
         ...
         <div id="main" v-if="overlayVisible">
            ...
            <div class="content">
               <div class="img">
                  <img src="/assets/images/eagle.png" alt="">
               </div>
               <div class="datasheet">
                  ...
                  <div class="grid">
                     <div>
                        <h3>Elétrica</h3>
                        <ul>
                           <li>100-240V AC, 47/63Hz</li>
                           <li>1,5 W (pico de 4 W com a unidade Gateway)</li>
                           <li>16 Amperes</li>
                        </ul>
                     </div>
                     ...
                     <div>
                        ...
                        <ul>
                           <li>(-30 a +55 °C)</li>
                           <li>Câmara eletrônica IP66</li>
                           <li>Conector externo IP44</li>
                           <li>PVC, resistente a UV</li>
                           <li>Altura 291 mm, Largura 100 mm, Profundidade 120 mm</li>
                           <li>680 g</li>
                        </ul>
                     </div>
                  </div>
